Meteor.methods({
    ...
    'completeTask': function(studentID, taskID) {
        var selector = {
            taskId: taskID,
            userId: studentID
        };
    ...
    'saveProgressOther': function(studentID, instrumentName, oldSeconds, secondsPracticed) {
        var deltaT = secondsPracticed - oldSeconds;
    ...
    'addExperience': function(amt, user, instrument) {
        console.log("add exp")
        InstrumentStats.update({
    ...
    'isVivaldi': function(userId) {
        var vivaldi = Meteor.users.findOne({
            'emails.address': 'vivaldimailer@gmail.com'
        });
        console.log(vivaldi);
        console.log(vivaldi._id + ' ' + userId);
        if (userId == vivaldi._id) {
            console.log('truev');
            return true;
        } else {
            console.log('falsev');
