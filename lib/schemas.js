...
// created and linked to a specific section chat or user chat, and activated
//or deactivated depending on if there's new data. 
var notificationSchema = new SimpleSchema({
    ...
    type: {
        type: String,
        label: "Type"
        // practiceTask (tasks and posts not being used for now)
        // audioTask
        // postTask
        // studentPost
        // sectionChat
    ...
    mostRecent: {
        type: Date,
        label: "Most Recently Activated Date"
    },
    active: {
        type: Boolean,
        label: "Active"
