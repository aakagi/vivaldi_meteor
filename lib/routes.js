...
Router.route('/home', function () {
  if (Meteor.userId()){
    this.layout('general_layout', {data: {title: 'Vivaldi'}});
...
Router.route('/class', function(){
  if (Meteor.userId()){
    ...
    this.layout('general_layout', {data: {title: thisClass.name}});
...
Router.route('/section', function(){
  if (Meteor.userId()){
    ...
    this.layout('general_layout', {data: {title: thisSection.name + ' - Section'}});
...
Router.route('/user', function(){
  if (Meteor.userId()) {
    ...
    this.layout('general_layout', {data: {title: thisUser.profile.firstName + ' ' + thisUser.profile.lastName}});
...
Router.route('/task', function() {
  if (Meteor.userId()) {
    ...
    this.layout('general_layout', {data: {title: thisTask.type}});
